...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/src/main/webapp/style.css">
	<link rel="stylesheet" type="text/css" href="/src/main/webapp/style1.css">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item"><a class="nav-link" href="https://contact.com/">Contact</a></li>
			</ul>
		</div>
	</div>
</nav>
